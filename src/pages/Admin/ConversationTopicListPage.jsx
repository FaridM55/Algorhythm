...
const ConversationTopicListPage = () => {
  const { data, isFetching } = useGetConversationTopicsQuery();

  const [deleteAlgorithm] = useDeleteConversationTopicMutation();
      ...
      <Layout>
        <Card sx={{ padding: 4, marginTop: 10 }}>
          <div className='d-flex justify-content-between align-items-center'>
            <h1 className='mb-3'> İcma mövzuları </h1>
            <Link to='/admin/conversation-topics/create'>
...
export default ConversationTopicListPage;
